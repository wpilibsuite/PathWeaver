...
/**
 * This class provides a partial implementation of the Spline interface, and
 * also sets up drag and drop for this Spline.
 *
 * Note: This abstract class places drag and drop constraints on implementors.
 * Implementors will need to make sure {@link CurrentSelections} endpoints get
 * updated for dragging in the middle of a Path to work.
 *
