...
public final class SaveManager {
	 ...
	 * edited so the user can be prompted to save them upon exit.
	 *
	 ...
	 *
	 * @param allowCancel
	 *            Whether to allow the user to cancel the save.
	 ...
	 *            Path to save.
	 * @param remove
	 *            Whether to remove Path from set of modified paths.
	 */
