...
public final class FxUtils {
	 ...
	 * @param eventHandler
	 *            the handler to call when the menu item is acted upon
	 *
	 ...
	 *
	 * @param node
	 *            The node to apply the classes to
	 */
	 ...
	 *
	 * @param node
	 *            The node to enable/disable subchild pseudoclasses on
	 * @param idx
	 *            The index of SUBCHILD_SELECTORS to set enabled. Use -1 to disable
	 *            all.
	 */
	 ...
	 *
	 * @param scene
	 *            The Scene of the current Pane.
	 * @param aClass
	 *            getClass() of the calling class.
	 */
