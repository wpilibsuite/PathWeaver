...
/**
 * The class holding the global state for the currently selected objects. Those
 * who would like to remove this should refrain from doing so, as the necessary
 * plumbing is verbose and unwieldy.
 */
