...
public final class MainIOUtil {
	 ...
	 *
	 * @param directory
	 *            absolute location of directory
	 * @param root
	 *            Treeitem to add all new items as children
	 */
	 ...
	 *
	 * @param directory
	 *            The directory the file will be saved
	 * @param oldName
	 ...
	 * @param item
	 *            The treeitem that the file belongs to
	 * @param newName
	...
	public static void rename(String directory, TreeItem<String> item, String newName) {
		...
		if (oldFile.renameTo(newFile)) {
			...
			LOGGER.log(Level.WARNING, "Could not rename " + newFile.getAbsolutePath() + " already exists");
		} else if (oldFile.exists()) {
			LOGGER.log(Level.WARNING, "Could not rename , unknown error");
		} else {
			LOGGER.log(Level.WARNING, "Could not rename " + oldFile.getAbsolutePath() + " doesnt exist");
		}
	}
	 ...
	 *
	 * @param root
	 *            Root of new treeItem.
	 * @param name
	 *            String name for new treeItem.
	 *
	 ...
	 *            Name of auton file
	 * @param root
	 *            Auton treeItem to add new created items to.
	 */
	 ...
	 *
	 * @param location
	 *            Directory to save auton file
	 * @param filename
	 *            Name of new auton file
	 * @param root
	 *            Auton treeItem to save
	 */
