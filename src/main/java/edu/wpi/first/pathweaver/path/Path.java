 ...
 * {@link edu.wpi.first.pathweaver.path.wpilib.WpilibPath} for an example of
 * setting up drag and drop for the path and waypoints.
 * <p>
 ...
 * {@link Path}, the following variables must get set in
 * {@link CurrentSelections}:
 *
 * <ul>
...
public abstract class Path {
	 ...
	 * and after it. This implementation skips over non-existent waypoints, calling
	 * the {@link #updateTangent(Waypoint)} on the others.
	 *
	 * @param wp
	 *            the waypoint to recalculate tangents for
	 */
	 ...
	 * Implementors are free to make this function a no-op.
	 *
	 * @param wp
	 ...
	 * calls {@link #deselectWaypoint(Waypoint)} if the waypoint is currently
	 * selected and {@link #selectWaypoint(Waypoint)} otherwise.
	 *
	 * @param waypoint
	 *            the waypoint to toggle
	 */
	 ...
	 * {@link CurrentSelections}, making care to update the waypoint, as well as the
	 * current path.
	 *
	 * @param waypoint
	...
	/**
	 * Selects the given waypoint by calling the appropriate methods in
	 * {@link CurrentSelections}, making care to update the waypoint. This
	 * implementation does not currently null out
	 * {@link CurrentSelections#curPathProperty()} due to a NPE.
	 *
	 * @param waypoint
	 *            the waypoint to deselect
	 */
	...
	/**
	 * Reflects the Path across an axis. The coordinate system's origin is the
	 * starting point of the Path.
	 *
	 * @param horizontal
	 *            Flip over horizontal axis?
	 * @param drawPane
	 *            Pane to check validity of new points.
	 */
