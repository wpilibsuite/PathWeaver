...
public class FieldDisplayController {
	 ...
	 *
	 * @param fileLocations
	 *            The folder containing the path file
	 * @param newValue
	 *            The TreeItem holding the name of this path
	 ...
	 *
	 * @param horizontal
	 *            True if horizontal flip, false if vertical
	 */
	 ...
	 *
	 * @param pathDirectory
	 *            The directory to save the new path to.
	 * @return The new path.
	 */
